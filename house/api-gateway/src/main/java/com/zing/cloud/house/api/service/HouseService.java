...
import com.zing.cloud.house.api.dao.HouseDao;
import com.zing.cloud.house.api.model.*;
import com.zing.cloud.house.api.utils.BeanHelper;
...
public class HouseService {
    ...
    public void addHouse(House house, User user) {
        if (house.getHouseFiles() != null && !house.getHouseFiles().isEmpty()) {
            ...
            String images = Joiner.on(",").join(fileService.getImgPaths(files));
