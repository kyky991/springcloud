...
import com.zing.cloud.house.api.common.HouseUserType;
...
public class HouseDao {
    ...
    public List<City> getAllCitys() {
        RestResponse<List<City>> resp = Rests.exec(() -> {
    ...
    public List<Community> getAllCommunitys() {
        RestResponse<List<Community>> resp = Rests.exec(() -> {
    ...
    public List<House> getLastest() {
        RestResponse<List<House>> resp = Rests.exec(() -> {
