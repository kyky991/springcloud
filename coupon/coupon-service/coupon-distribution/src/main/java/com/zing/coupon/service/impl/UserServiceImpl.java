...
import com.zing.coupon.dao.CouponDao;
...
import com.zing.coupon.service.IUserService;
import com.zing.coupon.vo.*;
...
public class UserServiceImpl implements IUserService {
    ...
    public Coupon acquireTemplate(AcquireTemplateRequest request) throws CouponException {
        ...
        Coupon newCoupon = new Coupon(request.getTemplateSDK().getId(), request.getUserId(), couponCode,
                CouponStatus.USABLE);
